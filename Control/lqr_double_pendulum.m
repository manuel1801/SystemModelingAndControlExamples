...
figure
subplot(2,1,1)
plot(t_ol(1:end-1),x_ol([1,3],1:end-1))
legend({'$\theta_1$','$\dot \theta_1$'}, Interpreter="latex")
subplot(2,1,2)
plot(t_ol(1:end-1),x_ol([2,4],1:end-1))
...
figure
subplot(3,1,1)
plot(t_cl(1:end-1),x_cl([1,3],1:end-1))
legend({'$\theta_1$','$\dot \theta_1$'}, Interpreter="latex")
subplot(3,1,2)
plot(t_cl(1:end-1),x_cl([2,4],1:end-1))
legend({'$\theta_2$','$\dot \theta_2$'}, Interpreter="latex")
subplot(3,1,3)
plot(t_cl(1:end-1),u_cl)
xlabel('$t$'); ylabel('$u$')
